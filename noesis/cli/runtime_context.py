...
from noesis.runtime.config_provider import RuntimeContext, get_config_port
...
def load_runtime_context(port_specs: Sequence[str] | None = None) -> RuntimeContext:
    config_provider = get_config_port()
    config_ports = load_toml_port_specs()
    entry_ports = discover_entrypoint_ports()
    return build_context_from_sources(
