"""
Local episode store for Noēsis.

Persists lightweight metadata to a JSONL log and, optionally, maintains a
vector search index via FAISS. The store makes it easy to scan prior
episodes, enforce TTL-based retention, and surface provenance for learning.
"""
