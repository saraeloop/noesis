...
The manifest provides integrity verification for all artifacts with SHA-256 hashes and optional HMAC signatures for tamper detection.
...
```json
{
  ...
  "episode_id": "ep_20251108_120000_abc123_def4_s0",
  ...
  "hmac": "optional_hmac_signature_for_tamper_detection"
}
```
