...
Noēsis drops an explicit cognitive loop on top of any agent stack, so every run is an observable episode—context in, actions out—with Intuition, Direction, and Insight captured as immutable artifacts.
...
<Steps>
  ...
  <Step title="Add policies">
    Follow the [Guarded LangGraph Agent tutorial](/tutorials/guarded-langgraph-agent) to add guardrails to your agents.
  </Step>
</Steps>
