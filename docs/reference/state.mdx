...
<ResponseField name="episode.adapter" type="string">
Adapter used for execution.
</ResponseField>
...
<ResponseField name="episode.completed_at" type="string">
...
<ResponseField name="goal.context" type="object">
...
<ResponseField name="outcomes.actions[].id" type="string" required>
Unique action identifier.
</ResponseField>

<ResponseField name="outcomes.actions[].tool" type="string">
Tool that was invoked.
</ResponseField>

<ResponseField name="outcomes.actions[].input" type="any">
Input to the action.
</ResponseField>

<ResponseField name="outcomes.actions[].output" type="any">
Output from the action.
</ResponseField>

<ResponseField name="outcomes.actions[].timestamp" type="string" required>
When the action was executed.
</ResponseField>

<ResponseField name="outcomes.actions[].duration_ms" type="number">
Action duration in milliseconds.
</ResponseField>

<ResponseField name="outcomes.metrics" type="object">
Evaluation metrics (e.g., `task_score`).
</ResponseField>

<ResponseField name="outcomes.artifacts" type="array">
List of produced artifact paths.
</ResponseField>

<ResponseField name="outcomes.error" type="string">
...
```json
{
  ...
  "goal": {
    "task": "Draft release notes for v1.2.0",
    "context": {"changelog_path": "CHANGELOG.md"}
  },
  "beliefs": [
    {
      "statement": "Version 1.2.0 includes 3 new features",
