...
2. Enforce side effects once (e.g., [Governed Side Effects](/tutorials/governed-side-effects)).
...
- Want to see vetoes? → [Governed Side Effects](/tutorials/governed-side-effects)
